...
import {TX_TYPE, TxData, TxDataEditCandidate} from '~/src';
import decodeToArray from '../decode-to-array';

describe('TxDataEditCandidate', () => {
    const params = {
    ...
    const serializedTxData = (new TxDataEditCandidate(params)).serialize();
    ...
    test('TxData', () => {
        expect(TxData(params, TX_TYPE.EDIT_CANDIDATE).serialize()).toEqual(serializedTxData);
    });
});
