import {TxDataRecreateCoin, coinToBuffer, TxData, TX_TYPE} from '~/src';
import decodeToArray from '../decode-to-array';

describe('TxDataRecreateCoin', () => {
    const params = {
    ...
    const serializedTxData = (new TxDataRecreateCoin(params)).serialize();
    ...
    test('TxData', () => {
        expect(TxData(params, TX_TYPE.RECREATE_COIN).serialize()).toEqual(serializedTxData);
    });
});
